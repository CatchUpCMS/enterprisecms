    ...
    <div class="collapse navbar-collapse" id="navbar-collapse">
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tabs-pane @yield('staffs-bar')" id="tabB">
                <ul class="nav navbar-nav">
                    <li id="bar" @yield('staffs')><a href="{{ url('agents') }}">Staffs</a></li>

                    <li id="bar" @yield('departments')><a href="{{ url('departments') }}">Departments</a></li>

                    <li id="bar" @yield('teams')><a href="{{ url('teams') }}">Teams</a></li>

                    <li id="bar" @yield('groups')><a href="{{ url('groups') }}">Groups</a></li>
            ...
            <div role="tabpanel" class="tabs-pane @yield('settings-bar')" id="tabE">
                <ul class="nav navbar-nav">
                    ...
                    <li id="bar" @yield('auto-response')><a href="{{url('getresponder')}}">Auto-Response</a></li>
                    <li id="bar" @yield('alert')><a href="{{url('getalert')}}">Alert & Notice</a></li>
                </ul>
            </div>
            <div role="tabpanel" class="tabs-pane @yield('theme-bar')" id="tabF">
                <ul class="nav navbar-nav">
                    <li id="bar" @yield('footer')><a href="{{ url('create-footer') }}">Footer</a></li>

                    <li id="bar" @yield('footer2')><a href="{{ url('create-footer2') }}">Footer2</a></li>

                    <li id="bar" @yield('footer3')><a href="{{ url('create-footer3') }}">Footer3</a></li>

                    <li id="bar" @yield('footer4')><a href="{{ url('create-footer4') }}">Footer4</a></li>
