...
{{-- Web site Title --}}
@section('title')
{{ Lang::choice('core::cms.user_preferences', 2) }} :: @parent
@stop
...
<div class="input-group">
	<span class="input-group-addon"><i class="fa fa-tag fa-fw"></i></span>
		<input type="text" id="key" name="key" value="{{ $user_preference->key }}"  placeholder="{{ trans('core::cms.key') }}" class="form-control" autofocus="autofocus">
</div>
</div>
...
<div class="input-group">
	<span class="input-group-addon"><i class="fa fa-info fa-fw"></i></span>
		<input type="text" id="value" name="value" value="{{ $user_preference->value }}"  placeholder="{{ trans('core::cms.value') }}" class="form-control">
</div>
</div>
...
{{--
	...
	<div role="tabpanel" class="tab-pane padding fade @if ($language->locale == $lang)in active @endif" id="lang_{{{ $language->id }}}">
		...
		<div class="form-group">
			<label for="title">{{ Lang::choice('core::cms.value', 1) }}</label>
...
<div class="row">
<div class="col-sm-4">
	<a href="/admin/menulinks" class="btn btn-default btn-block" title="{{ trans('core::button.cancel') }}">
