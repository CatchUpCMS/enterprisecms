...
<div class="col-sm-6 margin-top-xl">
	...
	<div class="input-group">
		<span class="input-group-addon"><i class="fa fa-tag fa-fw"></i></span>
			<input type="text" id="name" name="name" value="{{ $menu->name }}" placeholder="{{ trans('core::account.name') }}" class="form-control">
	</div>
	</div>
	...
	<div class="input-group">
		<span class="input-group-addon"><i class="fa fa-css3 fa-fw"></i></span>
			<input type="text" id="class" name="class" value="{{ $menu->class }}" placeholder="{{ trans('core::general.class') }}" class="form-control">
	</div>
	</div>
