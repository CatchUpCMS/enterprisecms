...
{{-- Web site Title --}}
@section('title')
{{ Lang::choice('core::cms.menu', 2) }} :: @parent
@stop
...
<h1>
	<p class="pull-right">
	<a href="/admin/menus/create" class="btn btn-primary" title="{{ trans('core::button.new') }}">
		<i class="fa fa-plus fa-fw"></i>
		{{ trans('core::button.new') }}
	</a>
	</p>
	<i class="fa fa-paperclip fa-lg"></i>
		{{ Lang::choice('core::cms.menu', 2) }}
	<hr>
</h1>
</div>
	...
	<tbody>
		@foreach ($menus as $menu)
			<tr>
				...
				<td>{{ $menu->name }}</td>
				<td>
					<a href="/admin/menus/{{ $menu->id }}/edit" class="btn btn-success" title="{{ trans('core::button.edit') }}">
						<i class="fa fa-pencil fa-fw"></i>
						{{ trans('core::button.edit') }}
					</a>
					<a href="/admin/menulinks/{{ $menu->id }}" class="btn btn-info" title="{{ trans('core::button.new') }}">
						<i class="fa fa-link fa-fw"></i>
						{{ Lang::choice('core::button.link', 2) }}
					</a>
				</td>
			</tr>
		@endforeach
