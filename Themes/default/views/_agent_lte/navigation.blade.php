...
<ul class="tabs tabs-horizontal nav navbar-nav navbar-left">
	<li role="presentation" @yield('Dashboard') id="dashboard"><a href="{{ url('agent/dashboard') }}">{!! trans('core::helpdesk.dashboard') !!}</a></li>
	<li role="presentation" @yield('Tickets') id="tickets"><a href="#ticket-tab" aria-controls="tab" role="tab" data-toggle="tab">{!! trans('core::helpdesk.tickets') !!}</a></li>
	<li role="presentation" @yield('KB') id="kb"><a href="#kb-tab" aria-controls="tab" role="tab" data-toggle="tab"" >{!! trans('core::helpdesk.knowledge_base') !!}</a></li>
</ul>
