...
-->
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ asset('themes/' . $activeTheme . '/assets/admin_lte/dist/css/AdminLTE.min.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('themes/' . $activeTheme . '/assets/admin_lte/dist/css/skins/_all-skins.min.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('themes/' . $activeTheme . '/assets/admin_lte/dist/css/skins/skin-black.css') }}">
    ...
    <script type="text/javascript"
            src="{{ asset('themes/' . $activeTheme . '/assets/faveo/lb-faveo/plugins/moment/moment.js') }}"></script>
...
<div class="wrapper">
    ...
    @include($activeTheme . '::' . '_agent_lte.navigation')
    ...
    @include($activeTheme . '::' . '_agent_lte.footer')

    @include($activeTheme . '::' . '_agent_lte.control_sidebar')
...
-->
<script type="text/javascript"
        src="{{ asset('themes/' . $activeTheme . '/assets/admin_lte/dist/js/app.min.js') }}"></script>
<script type="text/javascript"
        src="{{ asset('themes/' . $activeTheme . '/assets/admin_lte/plugins/fastclick/fastclick.min.js') }}"></script>
