            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown notifications-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" onclick="myFunction()">
                        ...
                        <span class="label label-warning" id="count">Notific</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="header">You have  (count) notifications</li>
                        <li>
                            <ul class="menu">
                                {{--{!! route('ticket.thread', 1) !!} {{ $notification->notification_id }} {!! $notification->icon_class !!} {!! $notification->message !!}--}}
                                        <li>
                                            <a href="#" class='noti_User'>
                                                <i class=""></i> Msg
                                            </a>
                                        </li>
                            </ul>
