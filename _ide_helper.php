...
namespace Caffeinated\Modules\Facades {
    ...
    class Module {
        ...
        {
            \Caffeinated\Modules\Modules::register();
        }
...
namespace Caffeinated\Themes\Facades {
    ...
    class Theme {
        ...
        public static function register()
        {
            return \Caffeinated\Themes\Themes::register();
        }
         ...
         * @static 
         */
        public static function registerNamespace($theme)
        {
            return \Caffeinated\Themes\Themes::registerNamespace($theme);
        }
        
        /**
         * Get all themes.
         *
         * @return \Caffeinated\Themes\Collection 
         * @static 
         */
        public static function all()
        {
            return \Caffeinated\Themes\Themes::all();
        }
        ...
        {
            return \Caffeinated\Themes\Themes::exists($theme);
        }
        ...
        public static function getPath()
        {
            return \Caffeinated\Themes\Themes::getPath();
        }
        ...
        public static function setPath($path)
        {
            return \Caffeinated\Themes\Themes::setPath($path);
        }
        ...
        {
            return \Caffeinated\Themes\Themes::getActive();
        }
        
        /**
         * Sets active theme.
         *
         * @return \Caffeinated\Themes\Themes 
         * @static 
         */
        public static function setActive($theme)
        {
            return \Caffeinated\Themes\Themes::setActive($theme);
        }
        ...
        {
            return \Caffeinated\Themes\Themes::getLayout();
        }
        ...
        {
            return \Caffeinated\Themes\Themes::setLayout($layout);
        }
        ...
        {
            return \Caffeinated\Themes\Themes::getView($view);
        }
        ...
        {
            return \Caffeinated\Themes\Themes::view($view, $data);
        }
        ...
        {
            return \Caffeinated\Themes\Themes::viewExists($view);
        }
         ...
         * @static 
         */
        public static function response($view, $data = array(), $status = 200, $headers = array())
        {
            return \Caffeinated\Themes\Themes::response($view, $data, $status, $headers);
        }
        ...
        {
            return \Caffeinated\Themes\Themes::getThemePath($theme);
        }
         ...
         * @static 
         */
        public static function getJsonPath($theme)
        {
            return \Caffeinated\Themes\Themes::getJsonPath($theme);
        }
         ...
         * @static 
         */
        public static function getJsonContents($theme)
        {
            return \Caffeinated\Themes\Themes::getJsonContents($theme);
        }
         ...
         * @static 
         */
        public static function setJsonContents($theme, $content)
        {
            return \Caffeinated\Themes\Themes::setJsonContents($theme, $content);
        }
        ...
        {
            return \Caffeinated\Themes\Themes::getProperty($property, $default);
        }
        ...
        {
            return \Caffeinated\Themes\Themes::setProperty($property, $value);
        }
        ...
        {
            return \Caffeinated\Themes\Themes::asset($asset);
        }
         ...
         * @static 
         */
        public static function secureAsset($asset)
        {
            return \Caffeinated\Themes\Themes::secureAsset($asset);
        }
